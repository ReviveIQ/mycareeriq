...
export const CATEGORY_GROUPS: CategoryGroup[] = [
  ...
  {
    group: "Facilities, Cleaning & Maintenance",
    emoji: "🧹",
    categories: [
  ...
  {
    group: "Personal Services & Wellness",
    emoji: "💆",
    categories: [
      "Massage Therapy",
  ...
  {
    group: "Food, Beverage & Agriculture",
    emoji: "🌾",
    categories: [
  ...
  {
    group: "Sports, Fitness & Recreation",
    emoji: "⚽",
    categories: [
  ...
  {
    group: "Security & Protective Services",
    emoji: "🛡️",
    categories: [
  ...
  {
    group: "Religion, Spirituality & Community",
    emoji: "🕊️",
    categories: [
      "Clergy & Ministry",
      "Chaplaincy",
